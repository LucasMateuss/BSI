...
def aluguel_airbnb(valor_diaria, dias):
    ...
    return(aluguel + (aluguel * 0.05) + 75)
...
def media_ponderada(prova, trabalho, exercicio):
    ...
    """
    medias = ((prova * 4) + (trabalho * 2) + (exercicio * 1)) / 7
    return(round(medias, 1))
def cadeira_massagem(valor_3_minutos, qt_minutos_uso):
    ...
    """
    valor = ceil(qt_minutos_uso / 3)
    return valor_3_minutos * valor
